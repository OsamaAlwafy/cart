...
//  echo "post id=".$_POST["id_cat"];
  // print_r($_POST);
  $_SESSION["id_catigory"] = $_POST["id_cat"];
  $_SESSION["basket"]=0;
  echo" id= ".$_SESSION["id_catigory"];
...
<div class="shadow   col-md-3 vh-20 col-8 p-3  ms-2 mb-2 bg-body rounded"> <!--start person-->
...
?>
           ...
           </div> <!--end row catigories-->
           </div> <!--end container catigory-->
    ...
    <section class="">
      <form action="">
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-auto">
            <p class="pt-2">
              <strong>Please Sign To Get All News</strong>
            </p>
          </div>
          <!--Grid column-->
...
<!-- Footer -->
 ...
 <!-- <script src="js/bootstrap.bundle.min.js" integrity="sha384-IQsoLXl5PILFhosVNubq5LC7Qb9DXgDA9i+tQ8Zj3iwWAwPtgFTxbJ8NT4GN1R8p" crossorigin="anonymous"> </script> -->
